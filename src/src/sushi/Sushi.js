...
export class Sushi {
  constructor(provider, networkId, testing, options) {
    ...
    this.ferreroAddress = contractAddresses.ferrero[networkId]
    this.ferreroMaster = contractAddresses.ferreroMaster[networkId]
	this.wbusdAddress = contractAddresses.wbusd[networkId]
	this.BNBBUSDPair = contractAddresses.BNBBUSDPair[networkId]
	this.FERREROBNBPair = contractAddresses.FERREROBNBPair[networkId]
	this.KITKATBNBPair = contractAddresses.KITKATBNBPair[networkId]
	this.BUSDUSDTPair = contractAddresses.BUSDUSDTPair[networkId]
	this.KITKATFERREROPair = contractAddresses.KITKATFERREROPair[networkId]
  }
