...
import useEarningsToUSD from '../../../hooks/useEarningsToUSD'
...
const Harvest: React.FC<HarvestProps> = ({ pid }) => {
  ...
  const pendingInUSD = useEarningsToUSD(pid)
        ...
        <StyledCardContentInner>
          ...
          <StyledCardActions>
            <Button
              ...
              text={pendingTx ? 'Collecting KITKAT' : 'Claim KITKAT'}
              onClick={async () => {
                setPendingTx(true)
                await onReward()
                setPendingTx(false)
