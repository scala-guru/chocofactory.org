...
import useAllowance from '../../../hooks/useFerreroAllowance'
import useApprove from '../../../hooks/useFerreroApprove'
import useModal from '../../../hooks/useModal'
import useStake from '../../../hooks/useFerreroStake'
import useFerreroStakedBalance from '../../../hooks/useFerreroStakedBalance'
import useTokenBalance from '../../../hooks/useTokenBalance'
import useUnstake from '../../../hooks/useFerreroUnstake'
...
const Stake: React.FC<StakeProps> = ({ lpContract, pid, tokenName }) => {
  ...
  const stakedBalance = useFerreroStakedBalance(pid)
    ...
    <Card>
      <CardContent>
        <StyledCardContentInner>
          <StyledCardHeader>
            <CardIcon>
              <StyledIcon src={KitKatlogo} alt="KitKat icon" />
            </CardIcon>
